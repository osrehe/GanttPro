...
/** Tope del plan a importar: 5 000 tareas con notas razonables caben con holgura. */
...
export const POST = handle(async (request) => {
  ...
  const input = await parseBody(request, importRequestSchema, MAX_IMPORT_BODY_BYTES);
